...
<html>
	...
	<script type="text/javascript">
	  function vaild(){
		  char ch=Document.getParameters("username").value;
	...
	<div id="sidebar">
					...
					<tr><td><br></td></tr>
					<tr><td>User Name:</td><td><input type="text" name="username" onchange=<% %>/></td></tr>
								<tr><td><br></td></tr>
			...
			<div id="header">
					<h4>
						<center><font color=#777>This is a <b>NHCE</b> Bengaluru, College Mini Project</font></center></font></a>
					</h4>
			</div>
